         ...
         <div class="grid grid-cols-12 pt-5">
             ...
             <div class="col-span-5  border-yellow-200 p-3 text-white flex-row">
                 <ul class="space-y-2">
                     ...
                     <li class="text-slate-700 text-xl font-mono italic border-b-2 border-yellow-200 px-2 bg-yellow-100 rounded-lg">
             ...
             <div class="col-span-7 border-l-4 border-yellow-200 p-2">
                 ...
                 <div class=" p-3 rounded-md bg-yellow-100 italic h-full">{!! $noti->description !!}</div>
